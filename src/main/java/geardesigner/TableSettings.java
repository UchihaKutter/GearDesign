...
public class TableSettings {
    ...
    public static final Object[][] INPUT_PARAMS_NAME_UNIT
            = new Object[][]{
            {"法向模数", null}, {"齿数(内齿为负)", null}, {"法向压力角", Angle.DEGREES},
            {"螺旋角", Angle.DEGREES}, {"法向变位系数", null}, {"齿顶高系数", null},
    ...
    public static final String[] BASE_TAN_AND_SPAN_PARAMS_COLUMNS = new String[]{"参数名", "计算值", null};
    public static final Object[][] BASE_TAN_AND_SPAN_PARAMS_NAME_UNIT
            ...
            {"端面压力角", Angle.DEGREES}, {"基圆", Length.MILLIMETERS}, {"当量齿数", null}, {"跨齿数", null}, {"公法线长度", Length.MILLIMETERS},
