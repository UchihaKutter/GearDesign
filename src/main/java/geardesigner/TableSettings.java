...
public class TableSettings {
    ...
    public static final String[][] INPUT_PARAMS_NAME_UNIT
            = new String[][]{
            {"法向模数", null}, {"齿数(内齿为负)", null}, {"法向压力角", "rad"},
            {"螺旋角", "rad"}, {"法向变位系数", null}, {"齿顶高系数", null},
    ...
    public static final String[][] ANY_CIRCLE_PARAMS_NAME_UNIT
            = new String[][]{{"齿顶圆端面压力角", "rad"}, {"分度圆处弧齿厚", "mm"}, {"任一圆处弧齿厚", "mm"}, {"任一园螺旋角", "rad"}, {
            "任一圆法向弦齿厚", "mm"}};
    /**
     * 公法线与跨帮距计算结果数据面板设置
     */
    ...
    public static final String[][] BASE_TAN_AND_SPAN_PARAMS_NAME_UNIT
            = new String[][]{{"分度圆直径", "mm"}, {"齿顶圆直径", "mm"}, {"齿根圆直径", "mm"}, {"端面压力角", "rad"}, {"基园", "mm"}, {"当量齿数"
            , null}, {"跨齿数", null}, {"公法线长度", "mm"}, {"公法线长度处直径", "mm"}, {"跨棒距测量点直径", "mm"}, {"跨棒距", "mm"}};
    /**
     * 偏差转换计算结果数据面板设置
     */
